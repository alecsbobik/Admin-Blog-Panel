...
if (isset($_POST['category_delete'])) {
    ...
    $query = "UPDATE categories SET status='2' WHERE id='$category_id' LIMIT 1"; // 2=deleted
    $query_run = mysqli_query($con, $query);
...
if (isset($_POST['category_update'])) {
    ...
    $query = "UPDATE categories SET name='$name', slug='$slug', description='$description', meta_title='$meta_title', meta_description='$meta_description', meta_keyword='$meta_keyword', navbar_status='$navbar_status', name='$name', status='$status' WHERE id='$category_id'";
    $query_run = mysqli_query($con, $query);
